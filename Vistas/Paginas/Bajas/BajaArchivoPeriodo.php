    <div class="modal modalBaja fade ModalBajaPeriodo" id="ModalBajaPeriodo" tabindex="-1" role="dialog" aria-labelledby="ModalBajaAlumnoTitle" aria-hidden="true" role="document">
        <div class="modal-dialog modal-dialog-centered modal-dialog modal-dialog-scrollable">
            <div class="modal-content" style="border: solid 1px silver;">
                ...
                <div class="modal-body p-4">
                    <form class="row" action="plantillas.php?pagina=Modulos/Periodo" method="post">

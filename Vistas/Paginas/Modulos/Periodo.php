...
<div class="ContenedorGeneralAdherente">
    <div class="infoTitular">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <form action="plantillas.php?pagina=Modulos/ResolucionesChoferes" method="post">
                    ...
                    <button type="submit" class="nav-link btnAtras"><i class="fas fa-reply"></i> Volver a Periodos</button>
                </form>
            </li>
            <li class="nav-item" role="presentation">
                                ...
                                <?php if ($ver['Digitalizado'] == 'NO') { ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <button class="btnSubir subir" data-descr="<?php echo $ver['idTramitesRequisitos']; ?>" data-toggle="modal" requisito="<?php echo $ver['TramitesRequisitosDetalles'] ?>" id_adherente="<?php echo $id_adherente ?>" data-target="#exampleModalCenter">
                                                Subir Archivo
                                            </button>
                                        </td>
                                    </tr>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;"><?php
                                            ...
                                            <?php  } ?>
                                            <button class="btnBorrar eliminar" type="button" id="<?php echo $ver[4]; ?>" archivo="<?php echo $ver[9]; ?>" url="Periodo" dominio="<?php echo $_REQUEST['Do']; ?>" idAdherente="<?php echo $Ia = $_REQUEST['Ia']; ?>" codUsu="<?php echo $codUsu ?>" Usuario="<?php echo $Rol; ?>" data-descr="<?php echo $Iag = $_REQUEST['Iag']; ?>" dniChofer="<?php echo $Dc ?>" creacion="<?php echo $ver[11] ?>" Fdesde="<?php echo $Vd ?>" Fhasta="<?PHP echo $Vh ?>" agencia="<?php echo $Ag ?>" nombreArchivo="<?php echo $ver[5] ?>" iT="<?php echo $Itr ?>" iR="<?php echo $Iru ?>" id_adherente="<?php echo $id_adherente ?>" data-toggle="modal" data-target="#ModalBajaPeriodo">Borrar</button>
                                        </td>
                                    </tr>
                                <?php  } ?>
        ...
        ?>
        <?php
        include_once 'Paginas/Altas/FormAltaArchivoPeriodo.php';
        include_once 'Paginas/Bajas/BajaArchivoPeriodo.php';
        ?>